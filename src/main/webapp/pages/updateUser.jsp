...
<head>
    ...
    <script type="text/javascript">
        ...
        function togo(username) {
            window.location.href="${pageContext.request.contextPath }/user/toListOrders?username="+username;
    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            <div class="container">
                            ...
                            <!-- Form -->
                            <form action="${pageContext.request.contextPath }/user/toUpdateUser?id=${id}&user_name=${manager.username}" method="post">
                                <br><center><th>&#32; </th></center>
                                <br><center><th>&#32; </th></center>
                                <br><center><th> &#32;</th></center>
                                <center><th>用户昵称</th></center>
                                <div class="form-group">
                                    <input class="form-control" type="text" placeholder="username"name="username">
                                </div>
                                <center><th>用户密码</th></center>
                                <div class="form-group">
                                    <input class="form-control" type="text" placeholder="password"name="password">
                                </div>
                                <center><th>用户真实姓名</th></center>
                                <div class="form-group">
                                    <input class="form-control" type="text" placeholder="name"name="name">
                                </div>
                                <center><th>用户手机号</th></center>
                                <div class="form-group">
