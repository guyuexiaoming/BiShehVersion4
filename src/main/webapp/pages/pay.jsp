...
<div id="main">
    ...
    <form name=alipayment action=${pageContext.request.contextPath }/pages/alipay.trade.page.pay.jsp method=post
          target="_blank">
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                ...
                <dt>商品描述：</dt>
                <dd>
                    <input type="text" value="停车花费时间为：${orders.ordersTime}分钟，前15分钟免费，超时后每15分钟一元" name="WIDbody" />
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDout_trade_no").value =  "${orders.ordersId}";
        document.getElementById("WIDsubject").value = "停车付费";
        document.getElementById("WIDtotal_amount").value = "${orders.ordersMoney}";
    }
    GetDateNow();
</script>
</html>
