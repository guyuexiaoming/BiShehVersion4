...
<head>
    ...
    <script type="text/javascript">
        ...
        function togo(username) {
            window.location.href="${pageContext.request.contextPath }/user/toListUser?username="+username;
    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            <div class="container">
                ...
                <!-- Form -->
                <form action="${pageContext.request.contextPath }/order/toUpdateOrders?id=${id}&user_name=${manager.username}" method="post">
                    <br><center><th>&#32; </th></center>
                    <br><center><th>&#32; </th></center>
                    <br><center><th> &#32;</th></center>
                    <center><th>用户名</th></center>
                    ...
                    <center><th>用户车牌号</th></center>
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="carNumber"name="carNumber">
                    </div>
                    <center><th>订单金额</th></center>
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="money"name="money">
                    </div>
                    <center><th>服务耗时</th></center>
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="castTime"name="castTime">
                    </div>
                    <center><th>订单评价与服务</th></center>
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="eval"name="eval">
                    </div>
