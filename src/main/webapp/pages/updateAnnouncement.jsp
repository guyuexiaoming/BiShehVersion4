...
<head>
    ...
    <script type="text/javascript">
        ...
        function togo(username) {
            window.location.href="${pageContext.request.contextPath }/announ/toListAnnoun?username="+username;
    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            <div class="container">
                ...
                <!-- Form -->
                <form action="${pageContext.request.contextPath }/announ/toUpdateAnnouncement?id=${id}&user_name=${manager.username}" method="post">
                    <br><center><th>&#32; </th></center>
                    <br><center><th>&#32; </th></center>
                    <br><center><th> &#32;</th></center>
                    <center><th>标题</th></center>
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="title"name="title">
                    </div>
                    <center><th>正文内容</th></center>
                    <div class="form-group">

                        <textarea class="form-control" placeholder="编辑正文" id="context" name="content"></textarea>
                    </div>
