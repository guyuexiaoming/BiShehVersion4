						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a class="active" href="${pageContext.request.contextPath }/pages/product-details.jsp">Product View</a></li>
										...
										<div class="proimage-wrap">
											<div class="pro-image" id="pro_popup">
												<a href="../assets/img/product/product-01.jpg">
													<img class="img-fluid" src="../assets/img/product/product-01.jpg" alt="Product Image">
												</a>
											</div>
											<ul class="proimage-thumb">
												<li>
													<a href="../assets/img/product/product-01.jpg"><img src="../assets/img/product/product-thumb-01.jpg" alt="Product Image"></a>
												</li>
												<li>
													<a href="../assets/img/product/product-09.jpg"><img src="../assets/img/product/product-thumb-09.jpg" alt="Product Image"></a>
												</li>
												<li>
													<a href="../assets/img/product/product-10.jpg"><img src="../assets/img/product/product-thumb-10.jpg" alt="Product Image"></a>
												</li>
												<li>
													<a href="../assets/img/product/product-11.jpg"><img src="../assets/img/product/product-thumb-11.jpg" alt="Product Image"></a>
												</li>
											</ul>
										</div>
									</div>
											...
											<div class="product-reviews">
												...
												<ul class="review-list">
													...
													<li>
														<div class="review">
															<div class="review-author">
																<img class="avatar" alt="User Image" src="../assets/img/profiles/avatar-10.jpg">
															</div>
															<div class="review-block">
																<div class="review-by">
