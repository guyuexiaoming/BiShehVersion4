...
<head>
    ...
    <script type="text/javascript">
        function deleteById(id,username) {
            alert("id"+id);
            window.location.href="${pageContext.request.contextPath }/announ/toDeleteAnnoun?id="+id+"&username="+username;
        }
        function editUser(id,username) {
            alert("id"+id);
            window.location.href="${pageContext.request.contextPath }/announ/toUpdateAnnouncement.action?id="+id+"&username="+username;
        }
        function addUser(username) {
            window.location.href="${pageContext.request.contextPath }/announ/toAddAnnouncement.action?username="+username;
                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="${pageContext.request.contextPath }/order/toListOrders?username=${manager.username}">订单管理</a></li>
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <th><button class="btn btn-sm bg-success-light mr-2" id="edit_Account_btn1" onclick = "addUser('${manager.username}')"><i class="fe fe-pencil"></i>添加新公告</button></th>
                        <ul class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    <c:forEach items="${announList}" var="announ" varStatus="status">
                                        ...
                                        <ul>
                                            ...
                                            <tr>
                                                ...
                                                <th>${announ.anTitle }</th>
                                                <th>${announ.anBody }</th>

                                                <th><button class="btn btn-sm bg-danger-light" onclick = "deleteById('${announ.anId}','${manager.username}')"><i class="fe fe-trash"></i>删除</button></th>
                                                <th><button class="btn btn-sm bg-success-light mr-2" id="edit_Account_btn" onclick = "editUser('${announ.anId}','${manager.username}')"><i class="fe fe-pencil"></i>编辑</button></th>
                                            </tr>
                                    ...
                                    <ul>
                                        <th>
                                            <a href="${pageContext.request.contextPath }/announ/toListAnnoun?pn=1&username=${manager.username}">1</a>
                                        </th>
                                        <th>
                                            <a href="${pageContext.request.contextPath }/announ/toListAnnoun?pn=2&username=${manager.username}">2</a>
                                        </th>
                                        ...
                                        <th>
                                            <a href="${pageContext.request.contextPath }/announ/toListAnnoun?pn=${orders1.pageNum-1}&username=${manager.username}">上一页</a>
                                        </th>
                                        <th>
                                            <a href="${pageContext.request.contextPath }/announ/toListAnnoun?pn=${users1.pages}&username=${manager.username}">尾页</a>
                                        </th>
                                        <th>
                                            <a href="${pageContext.request.contextPath }/announ/toListAnnoun?pn=${users1.pageNum+1}&username=${manager.username}">下一页</a>
                                        </th>
