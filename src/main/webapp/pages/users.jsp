    ...
    <head>
		...
		<script type="text/javascript">
			function deleteById(id,username) {
				window.location.href="${pageContext.request.contextPath }/user/todeteleUser?id="+id+"&username="+username;
			}
			function editUser(id,username) {
				window.location.href="${pageContext.request.contextPath }/user/toUpdateUser.action?id="+id+"&username="+username;
			}
			function addUser(username) {
				window.location.href="${pageContext.request.contextPath }/user/toAddUser.action?username="+username;
			}
		</script>
    </head>
    <body>
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<th><button class="btn btn-sm bg-success-light mr-2" id="edit_Account_btn1" onclick = "addUser('${manager.username}')"><i class="fe fe-pencil"></i>添加账户</button></th>
								<ul class="breadcrumb">
									...
									<div class="table-responsive">
										<table class="table table-hover table-center mb-0">
											...
											<tbody>
												...
												<c:forEach items="${users}" var="user" varStatus="status">
													...
													<ul>
														...
														<tr>
															...
															<th>${user.name }</th>
															<th>${user.phone }</th>
															<th>${user.carnumber }</th>
															<th><button class="btn btn-sm bg-danger-light" onclick = "deleteById('${user.userId}','${manager.username}')"><i class="fe fe-trash"></i>删除</button></th>
															<th><button class="btn btn-sm bg-success-light mr-2" id="edit_Account_btn" onclick = "editUser('${user.userId}','${manager.username}')"><i class="fe fe-pencil"></i>编辑</button></th>
														</tr>
												...
												<ul>
													<th>
														<a href="${pageContext.request.contextPath }/user/toListUser?pn=1&username=${manager.username}">1</a>
													</th>
													<th>
														<a href="${pageContext.request.contextPath }/user/toListUser?pn=2&username=${manager.username}">2</a>
													</th>
													...
													<th>
														<a href="${pageContext.request.contextPath }/user/toListUser?pn=${orders1.pageNum-1}&username=${manager.username}">上一页</a>
													</th>
													<th>
														<a href="${pageContext.request.contextPath }/user/toListUser?pn=${users1.pages}&username=${manager.username}">尾页</a>
													</th>
													<th>
														<a href="${pageContext.request.contextPath }/user/toListUser?pn=${users1.pageNum+1}&username=${manager.username}">下一页</a>
													</th>
