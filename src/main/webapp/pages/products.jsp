						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a class="active" href="${pageContext.request.contextPath }/pages/products.jsp">Products</a></li>
					...
					<div class="row">
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								<div class="product-inner">
									<img alt="alt" src="../assets/img/product/product-01.jpg">
									<div class="cart-btns">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Apple MacBook Pro</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Samsung Galaxy S10 Plus</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Apple iMac Pro</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Fujifilm Digital Camera</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Apple Watch Series 4</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Apple iPhone Xs Max 6.5</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Logitech G633</a></h5>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="product">
								...
								<div class="pro-desc">
									<h5><a href="${pageContext.request.contextPath }/pages/product-details.jsp">Apple Magic Keyboard</a></h5>
