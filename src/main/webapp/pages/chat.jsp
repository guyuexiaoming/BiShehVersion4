							...
							<li>
								<div class="app-list">
									<div class="row">
										...
										<div class="col"><a class="app-item active" href="${pageContext.request.contextPath }/pages/chat.jsp"><i class="fa fa-comments"></i><span>Chat</span></a></div>
									</div>
								</div>
							</li>
						</ul>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a class="active" href="${pageContext.request.contextPath }/pages/chat.jsp">Chat</a></li>
															...
															<div>
																<div class="chat-msg-attachments">
																	<div class="chat-attachment">
																		<img src="../assets/img/product/product-01.jpg" alt="Product Image">
