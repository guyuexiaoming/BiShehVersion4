        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">维修申请管理与审批</h3>
                        <th><button class="btn btn-sm bg-success-light mr-2" id="edit_Account_btn1" onclick = "addUser('${manager.username}')"><i class="fe fe-pencil"></i>添加维修申请</button></th>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath }/man/toIndex.action?username=${manager.username}">回到主页</a></li>
                            <li class="breadcrumb-item active">维修申请列表</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    <c:forEach items="${rList}" var="r" varStatus="status">
                                        ...
                                        <ul>
                                            ...
                                            <tr>
                                                ...
                                                <th>${r.RMoney }</th>
                                                <th>${r.ROpinion }</th>
                                                <th><button class="btn btn-sm bg-danger-light" onclick = "deleteById('${r.RId}','${manager.username}')"><i class="fe fe-trash"></i>删除</button></th>
                                                <th><button class="btn btn-sm bg-success-light mr-2" id="edit_Account_btn" onclick = "editRepair('${r.RId}','${manager.username}')"><i class="fe fe-pencil"></i>编辑</button></th>
                                                <th><button class="btn btn-sm bg-success-light mr-2"  onclick = "dealRepair('${r.RId}','${manager.username}')"><i class="fe fe-pencil"></i>审批</button></th>
                                            </tr>
                                    ...
                                    <ul>
                                        ...
                                        <th>
                                            <a href="${pageContext.request.contextPath }/repair/toListRepair?pn=${orders1.pageNum-1}&username=${manager.username}">上一页</a>
                                        </th>
                                        <th>
                                            <a href="${pageContext.request.contextPath }/repair/toListRepair?pn=${pages.pages}&username=${manager.username}">尾页</a>
                                        </th>
                                        <th>
                                            <a href="${pageContext.request.contextPath }/repair/toListRepair?pn=${pages.pageNum+1}&username=${manager.username}">下一页</a>
                                        </th>
