					...
					<li class="nav-item dropdown app-dropdown">
						...
						<ul class="dropdown-menu app-dropdown-menu">
							<li>
								<div class="app-list">
									<div class="row">
										<div class="col"><a class="app-item active" href="${pageContext.request.contextPath }/pages/inbox.jsp"><i class="fa fa-envelope"></i><span>Email</span></a></div>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a class="active" href="${pageContext.request.contextPath }/pages/inbox.jsp">Email</a></li>
								</ul>
							</li>
							<li class="menu-title"> 
								<span>Pages</span>
									...
									<div class="email-content">
										<div class="table-responsive">
											<table class="table table-inbox table-hover">
												...
												<tbody>
													<tr class="unread clickable-row" data-href="mail-view.jsp">
														<td>
													...
													<tr class="clickable-row" data-href="mail-view.jsp">
														<td>
															<input type="checkbox" class="checkmail">
														</td>
														<td><span class="mail-important"><i class="fa fa-star-o"></i></span></td>
