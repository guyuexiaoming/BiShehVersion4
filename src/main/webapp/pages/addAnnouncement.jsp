    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            <div class="container">
                ...
                <!-- Form -->
                <form action="${pageContext.request.contextPath }/announ/addAnnouncement?user_name=${manager.username}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="编辑正文" id="context" name="content">
